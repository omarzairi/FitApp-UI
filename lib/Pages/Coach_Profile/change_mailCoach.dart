...
class ChangeMailCoach extends StatefulWidget {
  const ChangeMailCoach({super.key});

  @override
  State<ChangeMailCoach> createState() => _ChangeMailState();
}

class _ChangeMailState extends State<ChangeMailCoach> {
