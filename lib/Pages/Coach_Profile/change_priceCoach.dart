...
class ChangePriceCoach extends StatefulWidget {
  const ChangePriceCoach({super.key});

  @override
  State<ChangePriceCoach> createState() => _ChangePriceCoachState();
}

class _ChangePriceCoachState extends State<ChangePriceCoach> {
